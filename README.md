...
Módulo independiente de YummyPro para la gestión de clientes, plataformas, cuentas/cupos, suscripciones, vencimientos y renovaciones.

## Estructura
- `panel/`: panel operativo de Streaming.
- `demo/`: demostración pública del módulo.
- PWA y recursos compartidos del módulo.
