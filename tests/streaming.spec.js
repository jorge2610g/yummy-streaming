...
test('catálogo público Streaming y botón de previsualización están publicados', async ({ request }) => {
  ...
  expect(catalogBody).toContain('Powered by YummyPro · v1.1.3');

  const module = await request.get('/panel/streaming.js?v=1130');
